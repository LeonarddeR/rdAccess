...
from ..nvdaCompat import (
	BrailleDisplayGesture as _BrailleDisplayGesture,
	BrailleInputGesture as _BrailleInputGesture,
	applyRoutingIndex,
)
...
class BrailleInputGesture(_BrailleDisplayGesture, _BrailleInputGesture):
	def __init__(
		self,
		source: str,
		id: str,
